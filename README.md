...
- `plot_power_spectra_of_GLM_residuals.m`
  ...
  MATLAB script that plots power spectra of GLM residuals in AFNI, FSL and SPM. Written for fMRI researchers who want to check if their analyses might be effected by imperfect pre-whitening.
