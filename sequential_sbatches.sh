...
part=5; export part; sbatch --array=1-780 slurm_submit.array.hphi; sleep 60

#-transform results to MNI space and do cluster inference, all through FSL
part=6; export part; sbatch --array=1-780 slurm_submit.array.hphi; sleep 60
part=7; export part; sbatch --array=1-780 slurm_submit.array.hphi; sleep 60
