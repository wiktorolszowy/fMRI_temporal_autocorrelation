...
for (smoothing in smoothings[4]) {
   ...
   if (study=="CRIC_checkerboard") {
      exper_design_id = 4
   } else if (study=="CamCAN_sensorimotor") {
      exper_design_id = 17
   }
   ...
   path_output_exper_design = paste0(path_output, "/exper_design_", exper_design)
      ...
      system(paste0("cp ", path_manage, "/FSL_FEAT_designs/design_preproc_slice_timing_correction.fsf ", path_output_exper_design, "/preproc_feats_designs_slice_timing_correction/design_", subject, ".fsf"))
      setwd(paste0(path_output_exper_design, "/preproc_feats_designs_slice_timing_correction"))
      ...
      new_output = paste0(path_output_exper_design, "/preproc_feats_slice_timing_correction/", subject, "_preproc")
   ...
   path_output_exper_design_HRF = paste0(path_output_exper_design, "/HRF_", HRF_model, "_slice_timing_correction")
   setwd(path_output_exper_design_HRF)

   #-copy the FEAT dir from the 'preproc' step
   system(paste0("cp -a ", path_output, "/exper_design_", exper_design, "/preproc_feats_slice_timing_correction/", subject, "_preproc.feat/ ", path_output_exper_design_HRF, "/"))
   ...
   system(paste0("cp ", path_manage, "/FSL_FEAT_designs/design_", HRF_model, "_slice_timing_correction.fsf ", path_output_exper_design_HRF, "/design_", subject, ".fsf"))
   ...
   new_feat = paste0(path_output_top, "/FSL/smoothing_", smoothing, "/exper_design_", exper_design, "/HRF_", HRF_model, "_slice_timing_correction/", subject, ".feat")
