...
range_exper_designs = [4 17];  %[1 2 4 6 16 17 18];
range_smoothings    = 4;       %[2 4];
HRF_model           = 'gamma2_D';
...
for package_id      = range_packages
   ...
   for study_id     = range_studies
      ...
      for smoothing_id = range_smoothings
         ...
         path_subjects = [path_output study '/' package '/smoothing_' num2str(smoothing) '/exper_design_' exper_design '/HRF_' HRF_model '_slice_timing_correction'];
         cd(path_subjects);
